...
function ENT:Initialize()
	...
	self.Outputs = Wire_CreateOutputs(self.Entity, { "Zpos", "Xpos", "Ypos", "Speed", "Strength", "Resistance", "PropaneConsumption" })
end
...
function ENT:Think()
    ...
    Wire_TriggerOutput(self.Entity, "PropaneConsumption", self.propanecon)
	return true
end
