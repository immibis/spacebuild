...
if not (WireAddon == nil) then
    ENT.WireDebugName = "Large Processed Gas Tank"
end
...
function ENT:Initialize()
    ...
    RD_AddResource(self.Entity, "nitrogen",25000)
    RD_AddResource(self.Entity, "methane",25000)
    RD_AddResource(self.Entity, "propane",25000)
