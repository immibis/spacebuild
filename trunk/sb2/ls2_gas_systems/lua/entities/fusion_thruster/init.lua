...
function ENT:Initialize()
	...
	self.Outputs = Wire_CreateOutputs(self.Entity, { "On", "Energy Consumption", "Coolant Consumption", "Air Consumption" })
end
...
function ENT:CanRun()
	local air = RD_GetResourceAmount(self.Entity, "air")	
 ...
 function ENT:Think()
	...
	if not (WireAddon == nil) then
		...
		Wire_TriggerOutput(self.Entity, "Air Consumption", self.aircon)
...
function ENT:UpdateTextOutput()
	...
	self.Entity:SetNetworkedInt( 8, air)
	self.Entity:SetNetworkedInt( 9, energy)
	self.Entity:SetNetworkedInt( 10, coolant)
end
