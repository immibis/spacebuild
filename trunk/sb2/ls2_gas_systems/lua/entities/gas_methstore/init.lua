...
if not (WireAddon == nil) then
    ENT.WireDebugName = "Large Methane Tank"
end

function ENT:Initialize()
	self.Entity:SetModel("models/props_junk/trashdumpster01a.mdl")
    ...
    RD_AddResource(self.Entity, "methane", 8000)

	if not (WireAddon == nil) then self.Outputs = Wire_CreateOutputs(self.Entity, { "Methane", "Max Methane" }) end
...
function ENT:Destruct()
	...
	local magnit=math.floor(resource/130)
	local radius=math.floor(resource/190)
