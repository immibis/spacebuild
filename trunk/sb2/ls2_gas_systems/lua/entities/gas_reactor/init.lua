...
function ENT:Initialize()
	self.Entity:SetModel("models/props_citizen_tech/steamengine001a.mdl")
	...
	if not (WireAddon == nil) then self.Outputs = Wire_CreateOutputs(self.Entity, { "On", "Overdrive", "Propane Consumption", "Methane Consumption", "Energy Production"}) end
...
function ENT:GenerateEnergy()
	...
	if not (WireAddon == nil) then
        ...
        Wire_TriggerOutput(self.Entity, "Propane Production", self.propane)
    end
