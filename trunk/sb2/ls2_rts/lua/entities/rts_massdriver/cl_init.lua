...
function ENT:Draw()
	...
	--if (1 == 0) then
		...
		cam.Start3D2D(pos,angle,0.03)
			...
			surface.SetTextColor(155,255,155,255)
			surface.SetTextPos(500,TempY)
			surface.DrawText("Req. Energy: ".. self.Entity:GetNetworkedString( "Energy"))
			TempY = TempY + 70 
			
			surface.SetFont("RTSText")
			surface.SetTextColor(155,255,155,255)
			surface.SetTextPos(500,TempY)
			surface.DrawText("Packet: ".. self.Entity:GetNetworkedString( "Packet"))
			TempY = TempY + 70
			
			surface.SetFont("RTSText")
			surface.SetTextColor(155,255,155,255)
			surface.SetTextPos(500,TempY)
			surface.DrawText("Status: ".. self.Entity:GetNetworkedString( "Status"))
			TempY = TempY + 70

			surface.SetFont("RTSText")
			surface.SetTextColor(155,255,155,255)
			surface.SetTextPos(500,TempY)
			surface.DrawText("OverDrive: ".. self.Entity:GetNetworkedString( "OverDrive"))
			TempY = TempY + 70
