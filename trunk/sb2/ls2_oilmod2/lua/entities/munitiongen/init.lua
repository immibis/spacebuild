...
function ENT:Initialize()
	self.Entity:SetModel( "models/props_wasteland/kitchen_stove002a.mdl" )
	self.Entity:PhysicsInit( SOLID_VPHYSICS )
	self.Entity:SetMoveType( MOVETYPE_VPHYSICS )
	self.Entity:SetSolid( SOLID_VPHYSICS )
	self.Entity:SetColor(160,160,30,255)
...
function ENT:Think()
	...
	self.val2 = RD_GetResourceAmount(self.Entity, "12V Energy")
	self.val3 = RD_GetResourceAmount(self.Entity, "Oil")
	self.val4 = RD_GetResourceAmount(self.Entity, "Petrol")
