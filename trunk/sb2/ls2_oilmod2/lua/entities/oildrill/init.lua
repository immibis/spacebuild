...
function ENT:Initialize()
	...
	if ( self.Large ) then
		self.Entity:SetOverlayText( "Large Oil Drill" )
		if ( phys:IsValid() ) then
			phys:SetMass(18000) --make is heavy, very
		end
	else
		self.Entity:SetOverlayText( "Small Oil Drill" )
		if ( phys:IsValid() ) then
...
function ENT:Think()
	...
	if ( self.Large ) then
		...
		RD_SupplyResource(self.Entity, "Crude Oil", 890) --small
	end
