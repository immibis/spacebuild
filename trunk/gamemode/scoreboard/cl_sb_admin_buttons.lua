...
vgui.Register( "SB_SpawnMenuAdminButton", PANEL, "Button" )
...
vgui.Register( "SB_PlayerKickButton", PANEL, "SpawnMenuAdminButton" )
...
vgui.Register( "SB_PlayerPermBanButton", PANEL, "SpawnMenuAdminButton" )
...
vgui.Register( "SB_PlayerBanButton", PANEL, "SpawnMenuAdminButton" )
