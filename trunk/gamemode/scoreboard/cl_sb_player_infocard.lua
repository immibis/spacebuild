...
include( "cl_sb_admin_buttons.lua" )
include( "cl_sb_vote_button.lua" )
...
function PANEL:Init()
	...
	self.btnKick = vgui.Create( "SB_PlayerKickButton", self )
	self.btnBan = vgui.Create( "SB_PlayerBanButton", self )
	self.btnPBan = vgui.Create( "SB_PlayerPermBanButton", self )
	
	self.VoteButtons = {}
	
	self.VoteButtons[1] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[1]:SetUp( "exclamation", "bad", "This player is naughty!" )
	
	self.VoteButtons[2] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[2]:SetUp( "emoticon_smile", "smile", "I like this player!" )

	self.VoteButtons[3] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[3]:SetUp( "heart", "love", "I love this player!" )
	
	self.VoteButtons[4] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[4]:SetUp( "palette", "artistic", "This player is artistic!" )
	
	self.VoteButtons[5] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[5]:SetUp( "star", "star", "Wow! Gold star for you!" )
	
	self.VoteButtons[6] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[6]:SetUp( "wrench", "builder", "Good at building!" )
	
	//NEW
	self.VoteButtons[7] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[7]:SetUp( "wrench", "transport_builder", "Good at building transport ships!" )
	
	self.VoteButtons[8] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[8]:SetUp( "wrench", "fighter_builder", "Good at building fighters!" )
	
	self.VoteButtons[9] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[9]:SetUp( "wrench", "battle_cruiser_builder", "Good at building battle cruisers!" )
	
	self.VoteButtons[10] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[10]:SetUp( "wrench", "weapon_builder", "Good at building weapons!" )
	
	self.VoteButtons[11] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[11]:SetUp( "wrench", "defence_builder", "Good at building defences!" )
	
	self.VoteButtons[12] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[12]:SetUp( "star", "sb_star", "A star in the Spacebuild solar system!" )
	
	self.VoteButtons[13] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[13]:SetUp( "wrench", "ship_builder", "Good at building ships!" )
	
	self.VoteButtons[14] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[14]:SetUp( "exclamation", "bad_ship_builder", "Bad at building ships!" )
	
	self.VoteButtons[15] = vgui.Create( "SB_SpawnMenuVoteButton", self )
	self.VoteButtons[15]:SetUp( "emoticon_smile", "friendly_smile", "This player is helpfull!" )
...
vgui.Register( "SB_ScorePlayerInfoCard", PANEL, "Panel" )