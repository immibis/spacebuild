...
function PANEL:Init()
	...
	self.PlayerFrame = vgui.Create( "SB_PlayerFrame", self )
...
function PANEL:AddPlayerRow( ply )
	...
	local button = vgui.Create( "SB_ScorePlayerRow", self.PlayerFrame:GetCanvas() )
...
vgui.Register( "SB_ScoreBoard", PANEL, "Panel" )