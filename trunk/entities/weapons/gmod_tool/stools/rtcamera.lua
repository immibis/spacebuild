...
function TOOL:LeftClick( trace )
	...
	if (CameraList[ key ] && CameraList[ key ] != NULL ) then
		...
		ent:GetTable():SetLocked( locked )
		ent:GetTable():SetTracking( NULL,Vector(0))
...
function TOOL:RightClick( trace )
	...
	camera:GetTable():SetTracking( trace.Entity, trace.Entity:WorldToLocal( trace.HitPos ))
