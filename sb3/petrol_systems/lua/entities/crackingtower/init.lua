...
function ENT:Initialize()
	...
	RD.AddResource(self.Entity, "Crude Oil", 0)
...
function ENT:Think()
	...
	if (self.toggle == true) then
		self.Crude = RD.GetResourceAmount(self.Entity, "Crude Oil")
		...
		if (self.energy > 400) then
			...
			if (self.Crude > 1600) then
				...
				RD.SupplyResource(self.Entity, "Petrol", 600)
				RD.SupplyResource(self.Entity, "Oil", 700)
