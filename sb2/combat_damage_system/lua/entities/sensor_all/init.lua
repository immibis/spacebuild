...
function ENT:Initialize()
	...
	if not (WireAddon == nil) then
		...
		self.Outputs = Wire_CreateOutputs(self.Entity, { "Health", "Armor", "Temperature",  "On" })
	end
...
function ENT:TurnOff(warn)
	...
	if not (WireAddon == nil) then
		...
		Wire_TriggerOutput(self.Entity, "Heat", 0)
	end
end
...
function ENT:Sense()
	...
	if not (WireAddon == nil) then
		...
		Wire_TriggerOutput(self.Entity, "Armor", self.entArmor)
		Wire_TriggerOutput(self.Entity, "Heat", self.entHeat)
	end
...
function ENT:ShowOutput()
	...
	self.Entity:SetNetworkedInt( 2, self.entArmor )
	self.Entity:SetNetworkedInt( 3, self.entHeat )
end
