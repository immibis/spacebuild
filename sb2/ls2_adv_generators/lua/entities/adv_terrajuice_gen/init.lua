...
local Juice_Increment = 150
local Energy_Increment = 1000
local Air_Increment = 300
...
function ENT:Pump_Terrajuice()
	...
	if (energy >= einc) and water >= 5 and coolant >= (einc/2)  then
		...
		RD_ConsumeResource(self, "water", 300)
...
function ENT:Think()
	...
	self.Entity:NextThink( CurTime() + 7 )
	return true
end
