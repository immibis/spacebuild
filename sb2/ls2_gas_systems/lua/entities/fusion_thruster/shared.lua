...
function ENT:GetOverlayText()
	...
	local air = self.Entity:GetNetworkedInt(8)
	local energy = self.Entity:GetNetworkedInt(9)
	local coolant = self.Entity:GetNetworkedInt(10)
