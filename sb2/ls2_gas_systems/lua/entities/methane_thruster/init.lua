...
function ENT:Initialize()
	...
	self.Outputs = Wire_CreateOutputs(self.Entity, { "On", "Methane Consumption" })
end
...
function ENT:CanRun()
 ...
 function ENT:Think()
	...
	if not (WireAddon == nil) then
		Wire_TriggerOutput(self.Entity, "Methane Consumption", self.methanecon)
...
function ENT:UpdateTextOutput()
	...
	self.Entity:SetNetworkedInt( 8, methane)
end
