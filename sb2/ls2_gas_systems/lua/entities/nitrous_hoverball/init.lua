...
if not (WireAddon == nil) then
    ENT.WireDebugName = "Nitrous Oxide Hoverball"
end
...
function ENT:Initialize()
	...
	self.Outputs = Wire_CreateOutputs(self.Entity, { "Zpos", "Xpos", "Ypos", "Speed", "Strength", "Resistance", "NitrousOxideConsumption" })
end
...
function ENT:Think()
    ...
    Wire_TriggerOutput(self.Entity, "NitrousOxideConsumption", self.nitrouscon)
	return true
end
 ...
 function ENT:CanRun()
	...
	return (nitrous >= self.nitrouscon)
