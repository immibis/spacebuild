...
function ENT:Initialize()
	...
	if not (WireAddon == nil) then self.Outputs = Wire_CreateOutputs(self.Entity, { "On", "Overdrive", "Energy Consumption", "Nitrogen Consumption", "Air Production"}) end
...
function ENT:LiquidateNitro()
    ...
    if not (WireAddon == nil) then
        ...
        Wire_TriggerOutput(self.Entity, "Air Production", self.air)
    end
	...
	if ( self:CanRun() ) then
        ...
        RD_SupplyResource(self.Entity, "air",self.air)
