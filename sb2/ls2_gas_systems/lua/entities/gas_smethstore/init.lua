...
if not (WireAddon == nil) then
    ENT.WireDebugName = "Small Methane Tank"
end
...
function ENT:Initialize()
    ...
    RD_AddResource(self.Entity, "methane", 3000)
...
function ENT:Destruct()
	...
	if (resource>3000) then
		resource=3000
	end
	
	local magnit=math.floor(resource/200)
	local radius=math.floor(resource/220)
